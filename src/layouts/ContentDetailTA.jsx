...
import NilaiBimbinganTA from "../layouts/NilaiBimbinganTA";
import NilaiSidangTA from "../layouts/NilaiSidangTA";

const ContentDetailTA = ({ onClose, data }) => {
  if (!data) return null;
  return (
    <>
      <div className="w-[85%] mx-auto p-8 border-2 border-secondary rounded-3xl flex relative bg-white">
        ...
        <div className="w-[60%] flex flex-col gap-y-8 border-secondary border-l pl-8">
          <div className="flex justify-center mb-10">
            ...
            <TabBarNilai content="Nilai Sidang" status="nonactive" />
          </div>
          {/* <NilaiBimbinganTA /> */}
          <NilaiSidangTA />
          <div className="w-[60%] flex justify-between mx-auto">
